...
export default function PulsarHubCard() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex h-full w-full items-center gap-3 px-4 py-3 sm:px-5">
        <span className="flex min-w-0 items-center gap-3">
          <span className="relative flex size-11 shrink-0 items-center justify-center rounded-xl bg-white/[0.16] text-white ring-1 ring-white/[0.28] shadow-[inset_0_1px_0_rgba(255,255,255,0.28)]">
            <Bot className="size-6" strokeWidth={2.25} />
          ...
          <span className="min-w-0">
            ...
            <span className="mt-1 block text-xs font-semibold leading-snug text-violet-100 sm:text-[13px]">
              Central de Atendimento
            </span>
            <span className="mt-1 block text-xs font-medium leading-snug text-white/78">
              CRM
            </span>
          </span>
        </span>
