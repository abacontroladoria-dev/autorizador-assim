...
-- Idêntico a supabase/migrations/20260819120000_tokens_mensal_auditoria_assim.sql
-- (nova função get_auditoria_assim_periodo, get_auditoria_assim vira wrapper
-- fino, e get_tokens_mensal para a tela "Token Mensal"). CREATE OR REPLACE em
-- tudo — nenhum DROP FUNCTION necessário, as assinaturas não mudam de tipo.
--
-- Depois de rodar, registrar no livro-caixa (bloco final deste arquivo).

-- =============================================================================
-- 20260819120000_tokens_mensal_auditoria_assim.sql
-- =============================================================================
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES
  ('20260819120000', 'tokens_mensal_auditoria_assim')
