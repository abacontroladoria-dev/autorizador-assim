...
-- Idêntico a supabase/migrations/20260820110000_encurta_observacao_solicitacao_enviada.sql
-- (recria só get_auditoria_assim_periodo — mesma assinatura, sem DROP).
--
-- Depois de rodar, registrar no livro-caixa (bloco final deste arquivo).

-- =============================================================================
-- 20260820110000_encurta_observacao_solicitacao_enviada.sql
-- =============================================================================
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES
  ('20260820110000', 'encurta_observacao_solicitacao_enviada')
