...
-- Idêntico a supabase/migrations/20260819100000_exclui_avaliacao_neuropsicologica_auditoria.sql
-- (as duas CREATE OR REPLACE FUNCTION) — só recreia get_auditoria_assim e
-- get_faltas_auditoria_assim com uma linha extra de exclusão cada. Idempotente
-- por natureza (CREATE OR REPLACE), seguro rodar em produção sem downtime.
--
-- Depois de rodar, registrar no livro-caixa (bloco final deste arquivo).

-- =============================================================================
-- 20260819100000_exclui_avaliacao_neuropsicologica_auditoria.sql
-- =============================================================================
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES
  ('20260819100000', 'exclui_avaliacao_neuropsicologica_auditoria')
