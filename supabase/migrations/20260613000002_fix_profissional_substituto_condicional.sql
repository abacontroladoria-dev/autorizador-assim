-- Fix: profissional_substituto deve ser preenchido apenas quando tratativa != agendado
-- Evita marcar como substituição quando o mesmo profissional faz a tratativa
