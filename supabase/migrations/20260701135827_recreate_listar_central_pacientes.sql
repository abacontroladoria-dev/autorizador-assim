-- Recria listar_central_pacientes após o pull do schema remoto
-- (20260701135826_remote_schema.sql) recriar vw_central_pacientes.
-- Corpo idêntico ao de 20260614000000_extend_central_pacientes_substituicao.sql
-- e ao deployado em produção (conferido via Management API em 2026-07-01).
