-- Cria tabela de anotações internas de glosa, keyed por bloco_id.
-- Separada de autorizacoes_assim (que não tem bloco_id) para preservar integridade arquitetural.
...
-- Recria a view incluindo motivo_glosa via LEFT JOIN na nova tabela.
