-- Reconstrói vw_modal_substituicao_terapeutas expondo terapia_nome (Terapia Real).
-- Compatibilidade deve ser determinada por terapia_nome, não por terapia_exibicao_nome.
-- terapia_exibicao_nome é mantida apenas para exibição na interface.
