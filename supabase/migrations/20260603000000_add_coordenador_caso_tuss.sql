-- Adiciona 'Coordenador de Caso' ao mapeamento TUSS da view agenda_tita_autorizacao.
-- Essa terapia (terapia_exibicao_nome='Coordenador de Caso') caía no ELSE NULL do CASE,
-- excluindo os registros do WHERE e impedindo que pacientes com esse tipo de terapia
-- aparecessem na página /solicitar.
-- Mapeamento: código TUSS 22070384 (mesmo de Psicologia ABA), conforme definição clínica.
