-- CCO-010: Atualizar upsert_atendimentos para incluir novos campos de tratativa
-- Adiciona id_profissional_tratativa e origem_tratativa (criados em 20260611000002)
...
COMMENT ON FUNCTION public.upsert_atendimentos IS
  'Upsert multiple session records into cco.atendimentos. Accepts array of JSON objects. v2: includes id_profissional_tratativa and origem_tratativa.';
