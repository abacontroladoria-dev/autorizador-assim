-- Apply global business rule: only consider sessions with status_agendamento = 'Agendado'
-- This filter ensures all KPIs respect the rule defined in cco-business-rules.md
...
BEGIN
  ...
  WHERE a.data_sessao BETWEEN p_data_inicio AND p_data_fim
    ...
    AND a.paciente_nome NOT IN ('Ainda não selecionado', 'Horário Admiistrático')
