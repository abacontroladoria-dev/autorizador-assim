-- Adiciona filtro a.ativo = true na view agenda_tita_autorizacao.
-- Registros com ativo=false representam agendamentos de grade substituídos quando
-- a clínica atualiza a grade no TiTa. Sem esse filtro, o array_agg em
-- vw_central_autorizacoes e vw_blocos_autorizaveis_assim incluía terapias antigas
-- junto com as ativas, exibindo "Aplicador ABA (PS) + Terapia Ocupacional" no card
-- quando apenas a terapia do registro ativo deveria aparecer.
