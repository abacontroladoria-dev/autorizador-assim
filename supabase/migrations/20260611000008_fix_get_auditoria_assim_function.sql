-- Atualiza get_auditoria_assim para excluir Aplicador ABA Escola/Casa e outros
-- via filtros hardcoded em agenda_sem_falta CTE.
--
-- Nota: Idealmente, isso seria feito via config_regras_terapias BLACKLIST_AUTORIZACAO,
-- mas há um problema com a população da tabela, então usando hardcoded como fallback.
