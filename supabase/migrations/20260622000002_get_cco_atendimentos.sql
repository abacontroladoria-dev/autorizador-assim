-- RPC pública para o frontend CCO
-- Retorna todas as sessões do período com ocorrências abertas, substituição e status de autorização embutidos.
-- SECURITY DEFINER: necessário para acessar o schema cco a partir de chamadas autenticadas via anon key.
